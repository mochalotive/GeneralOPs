...
void printHelpMessage()
{
  ...
  std::cout << "Usage: smcvstep [-help] " << std::endl
            ...
            << "         -frcweight              - Weight the arc (or chord) length by" << std::endl
            << "                                   the norm of the restraint force vector." << std::endl
            << "         -pmfweight              - Weight the arc (or chord) length by" << std::endl
            << "                                   the potental of mean force." << std::endl << std::endl
            ...
            << "         The -frcweight and -pmfweight options are mutually exclusive, if" << std::endl
            << "         non is given, no weights are applied." << std::endl
...
int main(int argc, char* argv[])
{
  ...
  if(found_frcweight && found_pmfweight)
  {
    std::cerr << "Error: The -frcweight and -pmfweight options are mutually exclusive" << std::endl
              << "Use smcvstep -help for help." << std::endl;
    return -1;
  }
